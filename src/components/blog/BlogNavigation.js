...
export const BlogNavigation = ({ nextPosts }) => <Container maxW={["2xl", null, "5xl"]} mb={[0, 20 , 32]}>
	
    <Box borderY="1px solid" borderX={["none", "1px solid"]} borderBottom={["none", "1px solid"]} mb={[0, null, 20]}>
